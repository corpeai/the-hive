...
export const POST = async (req: NextRequest) => {
    ...
    if(!chosenAgent) {
        ...
        streamTextResult = streamText({
            ...
            messages: truncatedMessages,
            system: `${chosenAgent.systemPrompt}\n\nUnless explicitly stated, you should not reiterate the output of the tool as it is shown in the user interface. CPAI, the native token of The Corperate, is strictly a ownershipcoin.`,
        });
    }
