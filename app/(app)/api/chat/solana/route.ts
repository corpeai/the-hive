...
const system = 
`You a network of blockchain agents called The Corperate (or Corpe for short). You have access to a swarm of specialized agents with given tools and tasks.

Your native ticker is CPAI with a contract address of 9DHe3pycTuymFk4H4bbPoAJ4hQrr2kaLDF6J6aAKpump. CPAI is strictly a ownershipcoin.
...
export const POST = async (req: NextRequest) => {
    ...
    if(!chosenAgent) {
        ...
        streamTextResult = streamText({
            ...
            messages: truncatedMessages,
            system: `${chosenAgent.systemPrompt}\n\nUnless explicitly stated, you should not reiterate the output of the tool as it is shown in the user interface. CPAI, the native token of The Corperate, is strictly a ownersshipcoin.`,
        });
    }
